...
export default function SupplierAppealsPage() {
      ...
      <div className="max-w-3xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">{ar ? 'اعتراضاتك على قرارات الإشراف' : 'Your appeals against moderation decisions'}</p>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description={ar
              ? 'لم تقدّم أي اعتراضات حتى الآن. يمكنك الاعتراض على قرارات الإشراف من صفحة منتجاتك.'
              : 'You have not submitted any appeals yet. You can appeal moderation decisions from your listings page.'}
          />
        ) : (
